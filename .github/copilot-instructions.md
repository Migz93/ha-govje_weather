...
- `entity/` — Base entity class (`GOVJEWeatherEntity`)
...
- Entity MRO: `(PlatformEntity, GOVJEWeatherEntity)` — order matters
...
- Debug level: `custom_components.govje_weather: debug` in `config/configuration.yaml`
