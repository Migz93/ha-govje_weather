...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `GOVJEWeather`
...
- Inherit from both platform entity and `GOVJEWeatherEntity` (order matters)
...
from custom_components.govje_weather.sensor import async_setup_entry
...
**Config entry data:** `entry_data: GOVJEWeatherData = hass.data[DOMAIN][entry.entry_id]`
