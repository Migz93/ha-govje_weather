...
- **`entity/`** - Base entity classes (inherit `GOVJEWeatherEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, GOVJEWeatherEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import GOVJEWeatherEntity`
