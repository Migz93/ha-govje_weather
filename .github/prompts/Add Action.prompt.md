...
**File:** `custom_components/govje_weather/services.yaml`
...
Create `custom_components/govje_weather/service_actions/[action_name].py`:

```python
"""[Action name] service action for GOVJE Weather."""
...
**File:** `custom_components/govje_weather/__init__.py`
...
**File:** `custom_components/govje_weather/const.py`
...
3. Find service action: `govje_weather.[action_name]`
...
- **Service actions directory:** `custom_components/govje_weather/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/govje_weather/services.yaml` (legacy filename)
- **Icons:** `custom_components/govje_weather/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/govje_weather/translations/*.json` under `services` key (legacy)
