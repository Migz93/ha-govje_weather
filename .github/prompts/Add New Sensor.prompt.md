...
- Create new sensor file in `custom_components/govje_weather/sensor/`
- Inherit from `GOVJEWeatherEntity` and `SensorEntity`
...
```python
"""[Sensor description] for GOVJE Weather."""
...
class GOVJEWeather[SensorName]Sensor(
    GOVJEWeatherEntity,
    SensorEntity,
):
...
- Entity: `custom_components/govje_weather/sensor/[sensor_name].py`
- Platform: `custom_components/govje_weather/sensor/__init__.py`
- Translations: `custom_components/govje_weather/translations/*.json`
