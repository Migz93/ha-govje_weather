...
- Inherit from `GOVJEWeatherEntity` and platform base class
...
- Entity: `custom_components/govje_weather/[platform]/[entity_name].py`
- Platform: `custom_components/govje_weather/[platform]/__init__.py`
