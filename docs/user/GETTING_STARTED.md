# Getting Started with GOVJE Weather

This guide will help you install and set up the GOVJE Weather custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/Migz93/ha-govje_weather`
6. Set category to "Integration"
7. Click "Add"
8. Find "GOVJE Weather" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/Migz93/ha-govje_weather/releases)
2. Extract the `govje_weather` folder from the archive
3. Copy it to `custom_components/govje_weather/` in your Home Assistant configuration directory
...
4. Select entities from "GOVJE Weather"
...
logger:
  default: warning
  logs:
    custom_components.govje_weather: debug
```
...
- Report issues at [GitHub Issues](https://github.com/Migz93/ha-govje_weather/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/Migz93/ha-govje_weather/discussions)
